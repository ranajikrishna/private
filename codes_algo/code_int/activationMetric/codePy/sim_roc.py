...
README: To run the code in command line: python -W ignore sim_roc.py

Notes: 
The following functions are used:-
main():  
import_data(): Imports data from excel files.
clean_data(): Cleans data to form relational tables for analysis.
clac_content(): Computes the total number of content a user has.
growth_metric(): Defines a metric that determines which are the fastest growing 
users in terms of positive customer engagement over the last year.
...
# Load data from .xlsx files. 
	...
	input_file = '/Users/vashishtha/myGitCode/circleup/Data_Users.xlsx' 
